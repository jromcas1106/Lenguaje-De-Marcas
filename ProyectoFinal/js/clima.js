...
// Horas que queremos mostrar
const horasObjetivo = ['00:00', '08:00', '12:00', '18:00'];

// Trae datos del clima desde la API
...
// Muestra el clima de hoy en horas clave
...
// Muestra clima para los próximos días
...
// Cambia el clima al seleccionar ciudad
selector.addEventListener('change', () => {
    obtenerClima(selector.value);
});

// Muestra clima al cargar la página
